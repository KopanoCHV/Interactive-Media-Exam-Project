...
const openImg8 = document.getElementById("openModal-8");
const closeBtn8 = document.getElementById("closeModal-8");
...
openImg8.addEventListener("click",(event) => {
...
if(currentPage === '/Project3/Project3.html'){
    ...
    Project3.classList.add("current");
